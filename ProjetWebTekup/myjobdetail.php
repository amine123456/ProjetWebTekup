    ...
    if ($result->num_rows > 0) {
      ...
      while($row = $result->fetch_assoc()) {
        ...
        <div class=\"action-buttons\">
          <a class=\"btn btn-success\" href=\"editjob.php?jobid=".$row['id']."\">Edit</a>
          <a class=\"btn btn-danger\" onClick=\"javascript: return confirm('Please confirm deletion');\" href=\"functions/deletejob.php?jobid=".$row['id']."\">Delete</a>
        </div>
      </div>
";
